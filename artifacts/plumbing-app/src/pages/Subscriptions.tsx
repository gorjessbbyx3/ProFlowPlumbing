      ...
      {showForm && (
        <Card className="p-6">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div><label className="block text-sm font-semibold mb-1">Service Type *</label><input required value={form.serviceType} onChange={e => setForm({...form, serviceType: e.target.value})} className="w-full border rounded-xl px-3 py-2.5" placeholder="e.g. Drain Maintenance" /></div>
